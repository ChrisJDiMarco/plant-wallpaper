...
enum WallpaperProgressionPrompt {
    static func masterPrompt(
        ...
        let levelDirection = direction(for: safeLevel, experienceMode: experienceMode)
        let placementRule = switch experienceMode {
        case .garden:
        ...
        return """
        Recreate the attached current WallpaperGarden scene as a gamified progression upgrade.
        ...
        Progression rules:
        - Make this feel like a natural next stage from the current image, not a totally unrelated replacement.
        ...
        - Level 1 should feel bare bones and beginner; Level 20 should feel almost absurdly luxurious, like a billionaire/sultan/lord-level fantasy estate or room.
    ...
    private static func direction(for level: Int, experienceMode: GardenExperienceMode) -> String {
