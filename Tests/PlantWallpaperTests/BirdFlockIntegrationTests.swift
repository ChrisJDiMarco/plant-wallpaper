...
struct BirdFlockIntegrationTests {
    ...
    func birdWebAssetsAreBundledAndExposeTenFlockSpecies() throws {
        ...
        #expect(main.contains("makeWingPanelGeometry"))
        #expect(main.contains("addBoneBetween"))
        #expect(main.contains("volumetricBackHighlight"))
        #expect(main.contains("shoulderSocket"))
        #expect(main.contains("humerusJoint"))
        #expect(main.contains("elbowJoint"))
        #expect(main.contains("wristJoint"))
        #expect(main.contains("radiusUlna"))
        #expect(main.contains("dorsalWingSheen"))
        #expect(main.contains("scapularCoverts"))
        #expect(main.contains("secondaryFeatherFan"))
        #expect(main.contains("primaryFeatherFan"))
        #expect(main.contains("primaryFeatherShaft"))
        #expect(main.contains("alulaFeathers"))
        #expect(main.contains("pectoralFlightMuscle"))
        #expect(main.contains("keelRidge"))
        #expect(main.contains("ContourFeather"))
        #expect(main.contains("applyArticulatedWingPose"))
        #expect(main.contains("heroScale"))
        #expect(main.contains("heroProfileNearWing"))
        #expect(main.contains("profileHumerusJoint"))
        #expect(main.contains("profileElbowJoint"))
        #expect(main.contains("profileWristJoint"))
        #expect(main.contains("profilePrimaryFeatherFan"))
        #expect(main.contains("profileSecondaryFeatherFan"))
        #expect(main.contains("profileBreastBadge"))
        ...
        #expect(flock.contains("isHeroBird"))
